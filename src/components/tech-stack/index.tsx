...
const LANGUAGE_DESCRIPTIONS: Record<string, string> = {
  ...
  Go:
    'Fast, compiled language for CLIs, network services and high-performance backends.',
  Rust:
    'Systems-level language focused on memory safety and blazing performance.',
  Java:
    'Enterprise-grade OOP language for large applications and Android development.',
  Kotlin:
    'Modern JVM language, the preferred language for Android apps.',
  Ruby:
    'Elegant scripting language — the language behind Ruby on Rails.',
  C:
    'Low-level systems programming — firmware, embedded devices and performance-critical code.',
  'C++':
    'High-performance systems and game development with fine-grained control.',
  'C#':
    'Microsoft ecosystem language for .NET apps, games (Unity) and Windows tools.',
  Swift:
    'Apples modern language for iOS, macOS and native Apple-platform apps.',
  Dart:
    'Language of the Flutter framework for cross-platform mobile and web apps.',
  SQL:
    'Query language for relational databases — schemas, migrations and analytics.',
  Vue:
    'Progressive JavaScript framework for building reactive single-page apps.',
  Lua:
    'Lightweight embeddable scripting — game modding, Neovim config and plugins.',
  PowerShell:
  ...
  Nix:
    'Declarative, reproducible configuration for systems and development environments.',
  MDX:
    'Markdown plus JSX — documentation sites and interactive content.',
};
    ...
    <div className="card bg-base-200 shadow-xl border border-base-300 mt-6">
      <div className="card-body p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <div className="text-base-content/60 text-xs sm:text-sm mt-1">
              Auto-generated from my GitHub repositories — click an icon for
              details
            </div>
          </div>
        </div>
        ...
        {loading || !techStack ? (
          ...
          <>
            <div className="flex flex-wrap gap-3">
              {techStack.slice(0, 24).map((entry) => (
                <button
                  key={entry.language}
                  onClick={() => setSelected(entry)}
                  title={entry.language}
                  className={`transition-transform hover:scale-110 focus:scale-110 focus:outline-none rounded-lg ${
                ...
                >
                  <img
                    src={skillIconUrl([iconIdFor(entry.language)])}
                    alt={entry.language}
                    width={48}
                    height={48}
                    loading="lazy"
            ...
            {selected && (
              <div className="mt-6 p-4 rounded-xl bg-base-100 border border-base-300">
                <div className="flex items-start gap-4">
                  <img
                    src={skillIconUrl([iconIdFor(selected.language)])}
